...
define config.name = _("One winter from the live of knyazhestvo")
...
define build.name = "Onewinterfromtheliveofknyazhestvo"
...
define config.save_directory = "Onewinterfromtheliveofknyazhestvo-1760925104"
