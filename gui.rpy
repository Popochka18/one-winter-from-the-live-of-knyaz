...
################################################################################
## Enhanced GUI Configuration Variables
## Add these to your existing gui.rpy or replace similar sections
################################################################################
...
## Secondary accent for important actions
define gui.accent_secondary = '#00ff00'
...
## Frame backgrounds
define gui.frame_background_color = '#00000099'
define gui.overlay_color = '#000000aa'

## Button colors
define gui.button_hover_background = '#ffffff22'
define gui.button_selected_background = '#ffffff44'
...
## Custom UI Element Sizes #####################################################

## Character customization
define gui.customization_preview_size = (400, 600)
define gui.customization_panel_width = 500
define gui.customization_option_height = 80

## Settings menu
define gui.settings_panel_width = 800
define gui.settings_tab_height = 40
define gui.settings_slider_width = 400


## Animation Transitions #######################################################

define gui.button_hover_transition = 0.2
define gui.frame_fade_transition = 0.3
define gui.menu_transition = dissolve


## Viewport Scrolling ##########################################################

define gui.viewport_scroll_speed = 50
define gui.viewport_drag_sensitivity = 1.0


## Notification Properties #####################################################

define gui.notify_background_color = '#000000dd'
define gui.notify_text_color = '#ffffff'
define gui.notify_duration = 3.25


## Additional UI Spacing #######################################################

## Character customization spacing
define gui.customization_category_spacing = 15
define gui.customization_option_spacing = 10

## Settings menu spacing
define gui.settings_section_spacing = 25
define gui.settings_option_spacing = 15